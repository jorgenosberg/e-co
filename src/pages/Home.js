    ...
    <Container>
      <Grid container spacing={2} justifyContent="center" position="relative" zIndex={1}>
        ...
        <Grid item xs={12} md={6} sx={{ textAlign: "left" }}>
          <Paper elevation={5} sx={{ p: 5, borderRadius: 5, height: 240 }}>
            <Tooltip
            ...
            <Typography textAlign="center">
              <BoltIcon sx={{ fontSize: "50px", backgroundColor: "secondary.main", borderRadius: "50%", color: "#fff" }} />
            </Typography>
            <Typography variant="h4" textAlign="center">
              Current price of electricity <Box sx={{ color: "secondary.main", fontWeight: "bold" }}>{price}  €/MWh</Box>
            </Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={6} sx={{ textAlign: "left" }}>
          <Paper elevation={5} sx={{ p: 5, borderRadius: 5, height: 240 }}>
            ...
            <Typography textAlign="center">
              <Co2Icon sx={{ fontSize: "50px", backgroundColor: "secondary.main", borderRadius: "50%", color: "#fff" }} />
            </Typography>
            <Typography variant="h4" textAlign="center">
              Current CO<sub>2</sub> emissions <Box sx={{ color: "secondary.light", fontWeight: "bold" }}>{emissions} g CO<sub>2</sub>eq/kWh</Box>
            </Typography>
          </Paper>
        </Grid>
      </Grid>
